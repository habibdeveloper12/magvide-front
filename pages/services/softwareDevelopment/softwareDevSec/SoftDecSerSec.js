    ...
    <Container>
      <div className="sm:flex justify-between px-3 sm:px-5 xl:px-0 py-8 sm:py-10 md:py-16 lg:py-20 xl:py-24">
        <div className="w-full sm:w-2/4">
          <div className="mx-auto mb-10 sm:mb-0 sm:mx-0 w-[95%] h-[300px]  md:h-[320px] lg:w-[95%] lg:h-[400px] xl:w-[497] xl:h-[499px] relative block">
            <Image
              fill
              src="/assets/software_&_app_development_image.png"
              alt="software_&_app_development_image"
            />
          </div>
        </div>
