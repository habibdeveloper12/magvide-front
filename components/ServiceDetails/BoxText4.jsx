...
const BoxText4 = () => { 
  return (
    ...
    <BlogHeading
      ...
      <BlogPara
        className=" text-sm sm:text-base lg:text-sm text-[#2B2B2B] font-inter pb-4"
        title="We will track down your lackest competitor unique and makes better content, url, structure, titles, BlogHeadings, interlinking, and body than them. Which will help your business rank in the top 1 in versions of keywords. We would make sure customers will be filled with only your business."
      />
         <BlogHeading
        className=" text-primary py-2 sm:py-3 md:py-1 lg:py-1 xl:py-1 lg:leading-[44px] xl:leading-[34px]    text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl font-bold font-pop"
