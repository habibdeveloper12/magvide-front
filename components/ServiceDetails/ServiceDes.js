...
const ServiceDes = () => {
  ...
  return (
    ...
    <div className="my-9 px-3 md:px-5 xl:px-0">
      <Tabs>
    <Flex flexDir={{base:"row"}} flexWrap={{ base:'wrap', lg: 'nowrap', md:'wrap'}} position="relative">
          <Box
            bg="#fff"
            ...
            >
              {tabList.map((tab, index) => (
                <Tab
                  ...
                  boxShadow={{base:"2px 2px 5px 2px rgba(0,0,0,0.1)", md:'none'}}           
                ...
                >
                  ...
                  <Image width={{base:'0px', sm:'0px' ,md:'16px'}} ml={'auto'} src="arrow.png"></Image>
                  </Box>
                </Tab>
              ))}
            </TabList>
