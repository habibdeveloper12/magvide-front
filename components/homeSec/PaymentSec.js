    ...
    <div className="bg-[#F0FBFF] py-10 sm:py-16 md:py-20 lg:py-24">
      <Container>
        ...
        <div className="flex justify-center items-center gap-x-2 md:gap-x-10 lg:gap-x-20">
          <div className="w-[100px] h-[26px] sm:w-[160px] sm:h-[41px] lg:w-[215.15px] lg:h-[55px] relative">
          ...
          <div className="w-[80px] h-[16px] sm:w-[120px] sm:h-[24px] lg:w-[163.30px] lg:h-[32.50px] relative">
